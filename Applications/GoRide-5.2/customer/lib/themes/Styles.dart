...
class Styles {
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(centerTitle: true, iconTheme: const IconThemeData(color: Colors.white), titleTextStyle: TextStyle(color: Colors.white, fontSize: 16, fontFamily: 'Poppins')),
    );
  }
}
