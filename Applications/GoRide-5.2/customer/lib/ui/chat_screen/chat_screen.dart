...
class _ChatScreensState extends State<ChatScreens> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 2,
        title: Text("${widget.driverName.toString()}\n#${widget.orderId.toString()}", maxLines: 2, style: TextStyle(color: Colors.white, fontSize: 14)),
        leading: InkWell(
            onTap: () {
              Get.back();
            },
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text("Me".tr, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400)),
                      Text(Constant.dateAndTimeFormatTimestamp(data.createdAt), style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400)),
                    ],
                  ),
                ],
              ),
          ...
          : Column(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(widget.driverName.toString(), style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400)),
                    Text(Constant.dateAndTimeFormatTimestamp(data.createdAt), style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400)),
                  ],
                ),
              ],
