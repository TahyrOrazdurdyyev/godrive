                                                      ...
                                                      Expanded(
                                                        child: Row(
                                                          children: [
                                                            ...
                                                            Text(controller.orderModel.value.duration.toString(), style: TextStyle(fontWeight: FontWeight.w500)),
                                                          ],
                                                        ),
                                                      ),
                                                    ],
                                              ...
                                              child: Padding(
                                                  ...
                                                  child: Center(
                                                    child: Row(
                                                      children: [
                                                        Expanded(
                                                            child: Text(controller.orderModel.value.status.toString(), style: TextStyle(fontWeight: FontWeight.w500))),
