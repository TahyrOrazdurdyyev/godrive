                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text("Login".tr, style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w600, fontSize: 18)),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 5),
                          child: Text("Welcome Back! We are happy to have \n you back".tr, style: TextStyle(fontFamily: 'Poppins', fontWeight: FontWeight.w400)),
                        ),
                        const SizedBox(
                          height: 20,
                        ),
                        TextFormField(
                            ...
                            style: TextStyle(fontFamily: 'Poppins', color: themeChange.getThem() ? Colors.white : Colors.black),
                  ...
                  TextSpan(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                          ...
                          style: TextStyle(fontFamily: 'Poppins', decoration: TextDecoration.underline)),
