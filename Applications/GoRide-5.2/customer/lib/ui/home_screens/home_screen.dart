                          ...
                          child: Column(
                            ...
                            children: [
                              Text(controller.userModel.value.fullName.toString(),
                                  style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 18, letterSpacing: 1)),
                              const SizedBox(
                                height: 4,
                              ),
                              Row(
                                children: [
                                  ...
                                  Expanded(child: Text(controller.currentLocation.value, style: TextStyle(color: Colors.white, fontWeight: FontWeight.w400))),
                                ],
                              ),
                            ],
                          ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text("Where you want to go?".tr, style: TextStyle(fontWeight: FontWeight.w600, fontSize: 18, letterSpacing: 1)),
                                    const SizedBox(
                                      height: 10,
                                    ),
                                    ...
                                    Text("Select Vehicle".tr, style: TextStyle(fontWeight: FontWeight.w500, letterSpacing: 1)),
                                    const SizedBox(
                                      height: 05,
                                    ),
                                    SizedBox(
