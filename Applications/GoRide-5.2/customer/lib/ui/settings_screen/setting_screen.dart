...
class SettingScreen extends StatelessWidget {
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                              ...
                                              child: DropdownButtonFormField(
                                                  ...
                                                  onChanged: (value) {
                                                    controller.selectedLanguage.value = value as LanguageModel;

                                                    LocalizationService().changeLocale((value as LanguageModel).code.toString());
                                                  ...
                                                  items: controller.languageList.map((item) {
                                                    return DropdownMenuItem(
                                                      value: item,
                                                      child: Text(item.name.toString(), style: TextStyle(fontWeight: FontWeight.w500)),
                                                    );
                                                  }).toList()),
                                            ),
                                          ],
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Expanded(child: Text("Light/dark mode".tr, style: TextStyle(fontWeight: FontWeight.w500))),
                                            SizedBox(
                                              width: Responsive.width(26, context),
                                              child: DropdownButtonFormField<String>(
                                                  ...
                                                  items: controller.modeList.map((item) {
                                                    return DropdownMenuItem(
                                                      value: item,
                                                      child: Text(item.toString(), style: TextStyle(fontWeight: FontWeight.w500)),
                                                    );
                                                  }).toList()),
                                            ),
                                          ],
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text("Support".tr, style: TextStyle(fontWeight: FontWeight.w500)),
                                            ],
                                          ),
                                        ),
                                      ),
                                        ...
                                        child: InkWell(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text("Delete Account".tr, style: TextStyle(fontWeight: FontWeight.w500))
                                            ],
                                          ),
                                        ),
                                      )
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget okButton = TextButton(
      child:  Text("OK".tr),
      onPressed: () async {
        // DEMO: Simulate account deletion
