                ...
                <form action="{{ route('intercity-service.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                                <input type="number" step="0.01" class="form-control" name="price_per_seat" value="{{ old('price_per_seat', $service->price_per_seat ?? '') }}" min="0" required>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                                <input type="number" step="0.01" class="form-control" name="price_full_vehicle" value="{{ old('price_full_vehicle', $service->price_full_vehicle ?? '') }}" min="0" required>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                                @if(isset($service) && $service->image)
                                    <div class="mb-2">
                                        <img src="{{ $service->image }}" width="100" height="100" alt="Current image">
                                    </div>
                                @endif
                                <input type="file" name="image" class="form-control" accept="image/*">
                                <div class="form-text text-muted">Upload new image (optional)</div>
                            </div>
                        </div>

                        <div class="form-group row width-50">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="enable" id="enable" {{ old('enable', $service->enable ?? true) ? 'checked' : '' }}>
