                ...
                <form action="{{ route('currency.store') }}" method="POST">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                                <input type="text" class="form-control" name="code" value="{{ old('code', $currency->code ?? '') }}" required maxlength="10">
                        ...
                        <div class="form-group row width-50">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="symbol_at_right" id="symbol_at_right" {{ old('symbol_at_right', $currency->symbol_at_right ?? false) ? 'checked' : '' }}>
                                <label class="form-check-label" for="symbol_at_right">{{trans('lang.symbol_at_right')}}</label>
                                <div class="form-text text-muted">Display symbol after amount</div>
                            </div>
                        </div>

                        <div class="form-group row width-50">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="is_active" id="is_active" {{ old('is_active', $currency->is_active ?? true) ? 'checked' : '' }}>
